 ...
 * <li>Data structures maintained by this class: list of listeners, list of pages, mapping
 * between pages and contexts, selected page.</li>
 * <li>{@code openPage(...)} methods create a context and update data structures, 
 *     but they do not notify listeners.</li>
 ...
 * <li>{@code firePageEvent(...)} method sends the event to explicit listeners 
 *     (does not call {@link ManagedPage} methods.</li>
 * </ul>
 * @author Tony Johnson (tonyj@slac.stanford.edu)
 * @version $Id: PageManager.java 16332 2015-09-14 22:18:07Z onoprien $
 */
