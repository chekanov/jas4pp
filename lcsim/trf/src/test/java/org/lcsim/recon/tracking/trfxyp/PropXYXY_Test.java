 ...
 *
 * $Id: PropXYXY_Test.java,v 1.1.1.1 2010/04/08 20:38:00 jeremy Exp $
 */
 ...
 * @author Norman Graf
 */
public class PropXYXY_Test extends TestCase
{
    ...
    public void testPropXYXY()
    {
        ...
        PropXYXY prop = new PropXYXY(2.0);
        ...
        double phi1[]={  Math.PI/2.,    Math.PI/2.,   Math.PI/2.,   Math.PI/2.,   Math.PI/2.,   Math.PI/2.};
        double phi2[]={5*Math.PI/6.,  5*Math.PI/6., 5*Math.PI/6., 5*Math.PI/6., 5*Math.PI/6., 5*Math.PI/6.};
