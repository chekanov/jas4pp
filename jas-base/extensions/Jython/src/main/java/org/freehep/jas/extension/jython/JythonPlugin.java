...
public class JythonPlugin extends Plugin implements FileHandler, URLHandler, StudioListener
{
   ...
   protected void postInit() 
   {
      ...
      sysProps.setProperty("python.packages.paths", "java.class.path,sun.boot.class.path,app.class.path,java.ext.dirs");
     //sysProps.setProperty("python.packages.paths", "java.class.path");
