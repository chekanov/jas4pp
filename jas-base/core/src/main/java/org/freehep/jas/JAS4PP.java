 ...
 * Jas3 application.
 *
 * @author S.Chekanov (based on tonyj) 
 * @version $Id: JAS4PP.java 16271 2015-03-27 21:13:29Z onoprien $
 */
public class JAS4PP extends Studio {
  ...
  public JAS4PP(String applicationName) {
...
//    JOptionPane.showMessageDialog(null, "Jas3 main "); // uncomment to enable debugger attachement
    ...
    try {
      new JAS4PP(title).createFrame(args).setVisible(true);
    } catch (Throwable t) {
  ...
  private class Preferences implements PreferencesTopic {
    ...
    public JComponent component() {
      return new GeneralPreferences(JAS4PP.this);
    }
