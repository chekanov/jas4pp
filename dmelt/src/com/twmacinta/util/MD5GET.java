...
/**
 * Fast implementation of RSA's MD5GET hash generator in Java JDK Beta-2 or higher.
 * <p>
 ...
 * reference implementation given in RFC1321 by RSA.  It passes the MD5GET
 ...
 * <p>
 * This Java class has been derived from the RSA Data Security, Inc. MD5GET 
 ...
 * this library should be named "MD5GET.so" and on Windows it should be
 * named "MD5GET.dll".  The code will attempt to locate the library in the
 * following locations in the order given:
 *
 * <ol>
 *   <li>The path specified by the system property
 *       "com.twmacinta.util.MD5GET.NATIVE_LIB_FILE"
 *        (be sure to include "MD5GET.so" or "MD5GET.dll"
 ...
 * instance of a com.twmacinta.util.MD5GET object is constructed (note that
 * the convenience stream objects will implicitly create an MD5GET object).
 * <p>
 * The first option is to set the system property
 * "com.twmacinta.util.MD5GET.NO_NATIVE_LIB" to "true" or "1".
 ...
 * com.twmacinta.util.MD5GET.initNativeLibrary(true) before any MD5GET objects
 * are constructed.
 *
...
public class MD5GET {
    ...
    /**
     * Initialize MD5GET internal state (object can be reused just by
