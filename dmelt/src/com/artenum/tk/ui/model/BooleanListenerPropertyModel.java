...
public class BooleanListenerPropertyModel implements BooleanListener {
    private Properties props;
    private String key;
    private ArrayList<PropertiesListener> listeners;

    public BooleanListenerPropertyModel(String key) {
	this(key, new Properties());
    }

    public BooleanListenerPropertyModel(String key, Properties propertyToUse) {
	props = propertyToUse;
	this.key = key;
	...
	props.setProperty(key, Boolean.toString(newValue));
	notifyListeners();
    }
