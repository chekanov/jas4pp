...
// draw sqrt
             ...
             if (sqrt == 1) {
               ...
               // System.out.println(h); 
               lg.drawLine(ts.x+xoffset-3*off,ts.y+yoffset-h,ts.x+xoffset+w-3*off,ts.y+yoffset-h);
               lg.drawLine(ts.x+xoffset-3*off,ts.y+yoffset-h,ts.x+xoffset-3*off-off,ts.y+yoffset-h+h);
               lg.drawLine(ts.x+xoffset-4*off-off,(int)(ts.y+yoffset-h+0.5*h),ts.x+xoffset-4*off-off+off,ts.y+yoffset-h+h);
               // small tip
