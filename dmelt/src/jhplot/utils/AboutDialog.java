...
// create about
      ...
      String k1="<h2> jHPlot: a graphical package of ScaVis</h2>";
      String k2="<b>Author: "+JHPlot.getAuthor()+"</b><br>";
      String k3="<b>Version: "+JHPlot.getVersion()+"</b><br>";
      String k4="Build time: "+JHPlot.getBuildTime()+"<br>";
      String k5="Created by: "+JHPlot.getCreatedBy()+"<br>";
      String all=k1+k2+k3+k4+k5;
      epane.setText(all);
    
      /*
      try {
      //   epane.setPage(  win.getHTMLUrl( "about.html" )  );
    	// epane.setText("<h2> jHPlot: a graphical package of SCaVis</h2>");
     }
      catch ( Exception e )
      {
