...
public class DoubleArray {
	...
	/**
	 * Adds a single value to a matrix, e.g. adds the constant value a to all
	...
	/**
	 * Returns an m x m matrix. result has constants along the diagonal and
	 * zeros everywhere else. Example:<br>
	 * <code>
	 ...
	 * 
	 * @param c
	 *            Values that lies along diagonal.
	 ...
	 * 
	 * @param m
	 *            Number of rows in returned matrix
	 * @param n
	...
	// The fill methods are included so we can have equivalent methods in
	// IntegerArray.
	// There are ambiguities between DoubleArray and IntegerArray if we try to
	// implement
	// equivalent versions of the one() methods in both. the fill() methods are
	// delineated
	// by the type of the fill constant. I wish I could get rid of one(m,n,c)
	// and one(m,c)
	 ...
	 * numbers. The bounds of the random numbers each column are in the arrays
	 * min and max. So the values in column j are uniformly distributed random
	 * numbers between min[j] and max[j]
	 * 
	 * @param m
	 *            Number of rows in matrix
	 * @param n
	 *            Number of columns in matrix
	 * @param min
	 *            minimum value of the random numbers in a column
	 * @param max
	 *            maximum value of the random numbers in a column
	 * @return 2D array of random numbers.
	 */
	public static double[][] random(int m, int n, double[] min, double[] max) {
		double[][] array = new double[m][n];
	...
	/**
	 * Provides an mxn matrix. Each column is a sequence of successive values of
	 * stepsize <em>pitch</em> and starts at <em>begin</em>. The columns are all
	 * identical.
	 * 
	 * @param m
	 *            Number of rows in matrix
	...
	/**
	 * Provides a sequence of successive values in an array. e.g. increment(4,
	 * 3, 2) = {3,5,7,9}
	 * 
	 * @param m
	 *            Size of array
	 ...
	 * @param pitch
	 *            Step size
	 * @return m point array. Sequence of values from begin to begin +
	 *         (m-1)*pitch
	 */
	...
	/**
	 * Generates an mxn matrix. Each column is a sequence of succesive values.
	 * Each column has it's own starting value and step size.
	 * 
	 * @param m
	 *            Number of rows in matrix
	 * @param n
	 *            Number of columns in matrix
	 * @param begin
	 *            Array of starting values for each column. length must = n.
	 * @param pitch
	 *            Array of step sizes for each column. length must = n.
	 * @return 2D array
	 */
	public static double[][] increment(int m, int n, double[] begin,
			double[] pitch) {
	...
	/**
	 * Generates an array of successive values from <em>begin</em> to
	 * <em>end</em> with step size <em>pitch</em>.
	 * 
	 * @param begin
	 *            First value in sequence
	 * @param pitch
	...
	/**
	 * Carve out a submatrix from the input matrix and return a copy. Result is
	 * the intersection of rows i1 through i2 and columns j1 through j2
	 * inclusive. Example:<br>
	 * <code>
	 ...
	 *            Input matrix
	 * @param i1
	 *            Index of first row in cut
	 * @param i2
	 *            Index of last row in cut
	 * @param j1
	 *            Index of first column in cut
	 * @param j2
	 *            Index of last column in cut
	 * @return submatrix. Input matrix is left unharmed.
	 */
	public static double[][] getSubMatrixRangeCopy(double[][] M, int i1,
	...
	/**
	 * Extract a range of columns from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	 ...
	 *            Input matrix
	 * @param j1
	 *            Index of first column to be extracted.
	 * @param j2
	 *            Index of last column to be extracted.
	...
	/**
	 * Extract specific columns from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	 ...
	 *            listed as there are columns in M.
	 * @return An mxn matrix where m=number of rows in M and n=number of indices
	 *         listed
	 */
	...
	/**
	 * Extract one <i>column</i> from a three dimensional array. The result is
	 * an array of the values in the first dimension.
	 * 
	 * @param M
	 *            Input 3D array
	 * @param j
	...
	/**
	 * Extract specific rows from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	 ...
	 *            Input matrix
	 * @param I
	 *            Each is the index of a column.
	 * @return An mxn matrix where m=number of indices listed and n=number of
	 *         columns in m
	 */
	...
	/**
	 * Extract a row from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	...
	/**
	 * Extract a range of rows from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	 ...
	 *            Input matrix
	 * @param i1
	 *            Index of first row to be extracted.
	 * @param i2
	 *            Index of last row to be extracted.
	 ...
	 *            Input array
	 * @param j1
	 *            Index of first term to get
	 * @param j2
	 *            Index of last term to get
	...
	/**
	 * Extract specific elements from an array. Example: <br>
	 * <code>
	 * double[] a = {00,11,22,33,44,55,66,77,88,99};<br>
	...
	/**
	 * Get the number of columns in a specified row of a matrix. Used for oddly
	 * sized matrices.
	 * 
	 * @param M
	 *            Input matrix
	 * @param i
	 *            Index of row whose column length will be returned
	...
	/**
	 * Extract diagonal from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,25,26,27,28}};<br>
	...
	/**
	 * Combine a set of arrays into a matrix. Each array becomes a row. Rows may
	 * be of different lengths. Example:<br>
	 * <code>
	 ...
	 * @param x
	 *            Input arrays
	 * @return A matrix. Will be non-rectangular if arrays are not all the same
	 *         length.
	 */
	...
	/**
	 * Combine a set of arrays into a matrix. Each array becomes a column.
	 * Arrays must all be of same length. Example:<br>
	 * <code>
	 ...
	 * @param x
	 *            Input arrays
	 * @return An mxn matrix where m=size of any input array and n is the number
	 *         of arrays.
	 */
	...
	/**
	 * Concatenates arrays. Example:<br>
	 * <code>
	...
	// I didn't favor this insertColumns method because it was so different from
	// insertRows()
	// and it just seemed more likely that someone would want to insert arrays
	// rather than
	// whole matrices. See the new version below.
	/*
	 * public static double[][] insertColumns(double[][] x, int J, double[]...
	 * y) { double[][] array = new double[x.length][x[0].length + y[0].length];
	 * System.out.println("y[0].length="+y[0].length); for (int i = 0; i <
	 * array.length; i++) { System.out.println(tostring("%3.0f",array)+"\n");
	 * System.arraycopy(x[i], 0, array[i], 0, J); System.arraycopy(y[i], 0,
	 * array[i], J, y[i].length); System.arraycopy(x[i], J, array[i], J +
	 * y[i].length, x[i].length - J); } return array; }
	 */
	/**
	 * Insert any number of arrays between 2 columns of a matrix. Size of the
	 * arrays must equal number of rows in the matrix. Example:<br>
	 * <code>
	 ...
	 *            Input m x n matrix.
	 * @param J
	 *            Index of column before which the new columns will be inserted.
	 * @param y
	 *            The arrays to be inserted
	 ...
	 * double[][] array = new double[x.length][x[0].length + 1]; for (int i = 0;
	 * i < array.length; i++) { System.arraycopy(x[i], 0, array[i], 0, J);
	 * array[i][J] = y[i]; System.arraycopy(x[i], J, array[i], J + 1,
	 * x[i].length - J); } return array; }
	 */

	/**
	 * Insert any number of arrays between 2 rows of a matrix. Size of the
	 * arrays must equal number of columns in the matrix. Example:<br>
	 * <code>
	 ...
	 *            Input m x n matrix.
	 * @param I
	 *            Index of row before which the new rows will be inserted.
	 * @param y
	 *            The arrays to be inserted
	...
	public static double[][] insertRows(double[][] x, int I, double[]... y) {
		...
		for (int i = 0; i < x.length - I; i++)
			System.arraycopy(x[i + I], 0, array[i + I + y.length], 0,
					x[i].length);
		return array;
	}
	 ...
	 * double[][] array = new double[x.length + 1][x[0].length]; for (int i = 0;
	 * i < I; i++) System.arraycopy(x[i], 0, array[i], 0, x[i].length);
	 * System.arraycopy(y, 0, array[I], 0, y.length); for (int i = 0; i <
	 * x.length - I; i++) System.arraycopy(x[i + I], 0, array[i + I + 1], 0,
	 * x[i].length); return array; }
	 */
	 ...
	 *            Input array.
	 * @param I
	 *            Index of element before which the values will be inserted.
	 * @param y
	 *            Values to be inserted. Can also be a single array.
	...
	/**
	 * Deletes a range of columns from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,23,24,25,26}};<br>
	...
	/**
	 * Deletes a list of columns from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,23,24,25,26}};<br>
	...
	public static double[][] deleteColumns(double[][] x, int... J) {
		/*
		 * double[][] array = new double[x.length][x[0].length - J.length]; for
		 * (int i = 0; i < array.length; i++) { System.arraycopy(x[i], 0,
		 * array[i], 0, J[0]); for (int j = 0; j < J.length - 1; j++)
		 * System.arraycopy(x[i], J[j] + 1, array[i], J[j] - j, J[j + 1] - J[j]
		 * - 1); System.arraycopy(x[i], J[J.length - 1] + 1, array[i],
		 * J[J.length - 1] - J.length + 1, x[i].length - J[J.length - 1] - 1); }
		 * return array;
		 */
	...
	/**
	 * Deletes a range of rows from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,23,24,25,26}};<br>
	...
	/**
	 * Deletes a list of rows from a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,1,2,3,4},{1,7,8,9,10},{2,13,14,15,16},{3,19,20,21,22},{4,23,24,25,26}};<br>
	...
	public static double[][] deleteRows(double[][] x, int... I) {
		...
		/*
		 * for (int i = 0; i < I[0]; i++) System.arraycopy(x[i], 0, array[i], 0,
		 * x[i].length); for (int j = 0; j < I.length - 1; j++) for (int i =
		 * I[j] + 1; i < I[j + 1]; i++) System.arraycopy(x[i], 0, array[i - j],
		 * 0, x[i].length); for (int i = I[I.length - 1] + 1; i < x.length; i++)
	...
	/**
	 * Delete a range of elements from an array. Example:<br>
	 * <code>
	 ...
	 *            Input array
	 * @param J1
	 *            Index of first element to delete. Must be >= 0 and <= x.length
	 * @param J2
	 *            Index of last element to delete. Must be >= J1 and <= x.length
	...
	/**
	 * Delete a list of elements from an array. Example:<br>
	 * <code>
	 * double[] b = {00,11,22,33,44};<br>
	 * double[] z = deleteRange(b, 1, 3);<br>
	 * Result is:<br>
	 ...
	 *            Input array
	 * @param J
	 *            Index of elements to delete. Each must be >= 0 and <= x.length
	 * @return Reduced array.
	 */
	public static double[] delete(double[] x, int... J) {
		...
		/*
		 * System.arraycopy(x, 0, array, 0, J[0]); for (int j = 0; j < J.length
		 * - 1; j++) System.arraycopy(x, J[j] + 1, array, J[j] - j, J[j + 1] -
		 * J[j] - 1); System.arraycopy(x, J[J.length - 1] + 1, array, J[J.length
		 * - 1] - J.length + 1, x.length - J[J.length - 1] - 1);
		 */
		return array;
	}
	...
	/**
	 * Generate a two column matrix. Second column is just the values in
	 * <em>Y</em> The first column is a uniform sequence of values from Xmin to
	 * Xmax. Step size is automatic. Useful for generating values for an x axis
	 * when y is already defined and bundling the pairs into a matrix. Example:<br>
	 * <code>
	 ...
	 * @param Xmax
	 *            The last value in the first column
	 * @param Y
	 *            An array that will fill the second column.
	...
	/**
	 * Finds the minimum value in each column of a matrix. Example:<br>
	 * <code>
	 ...
	 * 
	 * @param M
	 *            Can be a list of values e.g. min(1,22,333,.4) or an array.
	...
	/**
	 * Finds the maximum value in each column of a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,  1,  2,   3,  4},<br>
	 *                 {1,  7, 88,   9, 10},<br>
	 *                 {2, 13, 14,  15, 16},<br>
	 ...
	 * 
	 * @param M
	 *            Can be a list of values e.g. minIndex(11,22,44,2) or an array
	 ...
	 * 
	 * @param M
	 *            Can be a list of values e.g. maxIndex(11,22,44,2) or an array
	...
	/**
	 * Calculates the cumulative sum of each column in a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,  1,  2,  3,  4},<br>
	 *                 {1,  7,  8,  9, 10},<br>
	 *                 {2, 13, 14, 15, 16},<br>
	 ...
	 * 
	 * @param v
	 * @return Output matrix. Each column is the cumulative sum of each column
	 *         in v.
	 */
	public static double[][] cumSum(double[][] v) {
		int m = v.length;
	 ...
	 * @param v
	 *            Input matrix.
	 * @return An array of n values where n=number of columns in v. The i'th
	 *         element is product of the values in the i'th column of v.
	 */
	public static double[] product(double[][] v) {
		int m = v.length;
		int n = v[0].length;
	...
	/**
	 * Calculates cumulative product of the values in an array. Example:<br>
	 * <code>
	 * double[] b = {1,2,3,4};<br>
	...
	/**
	 * Calculates the cumulative product of each column in a matrix. Example:<br>
	 * <code>
	 * double[][] a = {{0,  1,  2,  3,  4},<br>
	 *                 {1,  7,  8,  9, 10},<br>
	 *                 {2, 13, 14, 15, 16},<br>
	 ...
	 * 
	 * @param v
	 * @return Output matrix. Each column is the cumulative product of each
	 *         column in v.
	 */
	public static double[][] cumProduct(double[][] v) {
		int m = v.length;
	 ...
	 * of a matrix or array. An extra space is automatically included. Note the
	 * lower case S. It's tostring() not toString(). Example:<br>
	 * <code>
	 ...
	 * array. Uses format specifier, e.g. "%5.3f", "%11.1E", ... An extra space
	 * is automatically included. Note the lower case S. It's tostring() not
	 * toString(). Example:<br>
	 * <code>
	 ...
	 * 
	 * @param format
	 *            A standard format specifier for one value
	 * @param v
	 *            Matrix or array
	 * @return A string of a nicely organized version of the matrix or array.
	 */
	...
	/**
	 * Throws an error exception if an argument is invalid. Handy to make sure
	 * the right number of values is passed around.
	 * 
	 * @param msg
	 *            Message to be printed if the error occurs.
	 * @throws IllegalArgumentException
	 */
	 ...
	 * Handy for making sure matrices are rectangular.
	 * 
	 * @param M
	 *            Input matrix
	 * @param n
	 *            Number of elements that should be in each row of M
	 * @throws IllegalArgumentException
	 */
	public static void checkColumnDimension(double[][] M, int n) {
		for (int i = 0; i < M.length; i++)
			if (M[i].length != n)
				throwError("row " + i + " have " + M[i].length
	 ...
	 *            Input matrix
	 * @param m
	 *            Number of elements that should be in each column of M.
	 * @throws IllegalArgumentException
	 */
	public static void checkRowDimension(double[][] M, int m) {
		if (M.length != m)
			throwError("columns have " + M.length + " rows instead of " + m
					+ " rows expected.");
	}
	 ...
	 *            Input array.
	 * @param n
	 *            Required number of elements in M
	 * @throws IllegalArgumentException
	 */
	public static void checkLength(double[] M, int n) {
		if (M.length != n)
			throwError("row have " + M.length + " elements instead of " + n
					+ " elements expected.");
	}
	...
	// function methods
	/**
	 * Apply a scalar function to every element of an array. Must import
	 * org.math.array.util.*; to get Function interface. The function named f in
	 * Function must be overridden. Be careful not to define any other functions
	 * named f in your code. Example:<br>
	 * <code>
	...
	/**
	 * Apply a scalar function to every element of an array. Must import
	 * org.math.array.util.*; to get Function interface. Example:<br>
	 * <code>
	 * double[] b = {1,2,3,4};<br>
	 * Function inverse = new Function() { public double f(double x) { return 1/x; }};<br>
	 * double[] z = f(b, inverse);<br>
	 ...
	 * Sort of a mutant version of increment(). Example:<br>
	 * <code>
	...
	/**
	 * Sorts the rows of a matrix using a specified column as the key. Example:<br>
	 * <code>
	 ...
	 * 2  4  2  5  6<br>
	 * 3  5  2  1  2<br>
	 * </code> Fixed (I hope) 3/28/06.
	 * 
	 * @param values
	 *            Input matrix
	 * @param column
	 *            Index of column to be used as the sorting key.
	...
	public static double[][] sort(double[][] values, int column) {
		...
		for (int i = 0; i < sorted_values.length; i++)
			System.arraycopy(values[s.getIndex(i)], 0, sorted_values[i], 0,
					values[s.getIndex(i)].length);

		return sorted_values;
	}

	/**
	 * Transposes an mxn matrix into an nxm matrix. Each row of the input matrix
	 * becomes a column in the output matrix.
	 * 
	 * @param M
	 *            Input matrix.
