...
/**
 * A collection of static methods for performing math operations on matrices and
 * arrays. Advanced Linear Algebra methods (decompositions, norm, ...) are just
 * call for JAMA routines.
 * 
 * @author richet
 */
public class LinearAlgebra extends DoubleArray {
	...
	/**
	 * Element-wise sum of any number of arrays. Each array must be of same
	 * length.
	 * 
	 * @param v
	...
	/**
	 * Element-wise product of any number of arrays. Each array must be same
	 * size.
	 * 
	 * @param v
	 *            Any number of arrays.
	...
	/**
	 * Matrix multiplication according to the rules of linear algebra. Matrices
	 * must be same size.
	 * 
	 * @param v1
	 *            Matrix
	 ...
	 * algebra. Number of columns in v1 must equal number of elements in v2.
	 * 
