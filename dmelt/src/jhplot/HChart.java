		...
		try {
			if (filetype.equalsIgnoreCase("png")) {
				 ...
				 */
                                ...
                                System.err.println("PS files not supported. You may use DataMelt for this file format");
                                /*
				try {
				...
				try {
					...
					System.err
							.println("Cannot find itext library, cannot create pdf.");
                                ...
                                System.out.println("Not supported by this version. You may use DataMelt for support of SVG files");
