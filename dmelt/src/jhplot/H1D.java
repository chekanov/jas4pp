...
public class H1D extends DrawOptions implements Serializable {
	...
	public void print() {
		...
		IAxis axis = h1.axis();
		System.out.println("");
		System.out.println("# SCaVis: output from H1D: " + this.title);
		System.out.println("# SCaVis: created at " + today);
	...
	public String toString() {
		...
		String today = String.valueOf(dat);
		IAxis axis = h1.axis();
		tmp = tmp + "# SCaVis: output from H1D: " + this.title + "\n";
		tmp = tmp + "# SCaVis: created at " + today + "\n";
 ...
 /**
	...
	public void toFile(String name) {
		...
		try {
			...
			tx.println("# SCaVis: output from H1D " + this.title);
			tx.println("# SCaVis: created at " + today);
